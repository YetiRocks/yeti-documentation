...
Step-by-step guides for building with Yeti. Each section covers a major capability of the platform with examples and best practices.
...
<div class="intro-card"><strong>Real-Time Features</strong><span>Server-Sent Events, WebSocket, PubSub, MQTT, and Kafka for live data streaming.</span></div>
<div class="intro-card"><strong>Caching & Performance</strong><span>Full-page caching, table expiration, and rate limiting.</span></div>
<div class="intro-card"><strong>Observability</strong><span>OpenTelemetry integration, structured logging, and the yeti_log! macro.</span></div>
</div>
